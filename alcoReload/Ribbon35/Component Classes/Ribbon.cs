...
namespace System.Windows.Forms
{
         ...
         : Control
    {
        ...
        private void SetActualBorderMode(RibbonWindowMode borderMode)
        {
            ...
            if (_actualBorderMode != borderMode)
        ...
        private void SetCaptionButtonsVisible(bool visible)
        {
            ...
            if (_CaptionButtonsVisible != visible)
        ...
        {
            ActualBorderModeChanged?.Invoke(this, e);
        }
        ...
        {
            CaptionButtonsVisibleChanged?.Invoke(this, e);
        }
        ...
        protected override void OnMouseDoubleClick(MouseEventArgs e)
        {
            ...
            RibbonTab tab = Tabs.FirstOrDefault(t => t.Bounds.Contains(e.Location));
            if (tab != null) { _minimized = !_minimized; }            
        }
