...
{
    public sealed class RibbonMenuItemList : RibbonItem,
       IContainsSelectableRibbonItems, IScrollableRibbonItem, IContainsRibbonComponents
    {
        ...
        #region Fields
        private RibbonMenuItemCollection _buttons;
        ...
        public RibbonMenuItemList()
        {
            _buttons = new RibbonMenuItemCollection(this);
        ...
        public RibbonMenuItemList(IEnumerable<RibbonButton> buttons)
         : this(buttons, null)
        {
        }

        public RibbonMenuItemList(IEnumerable<RibbonButton> buttons, IEnumerable<RibbonItem> dropDownItems)
         : this()
      {
            if (buttons != null)
            {
        ...
        /// </summary>
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public RibbonMenuItemCollection Buttons
        {
            get
            {
                return _buttons;
