...
namespace System.Windows.Forms
{
	...
	public class RibbonTab : Component, IRibbonElement, IRibbonToolTip, IContainsRibbonComponents
	{
      ...
      public object Tag
		...
		{
            TabContentBoundsChanged?.Invoke(this, e);
        }
		public void OnTabBoundsChanged(EventArgs e)
		{
            TabBoundsChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollRightVisibleChanged?.Invoke(this, e);
        }
		...
		{
            ScrollRightPressedChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollRightBoundsChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollRightSelectedChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollLeftVisibleChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollLeftPressedChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollLeftBoundsChanged?.Invoke(this, e);
        }
		/// <summary>
		...
		{
            ScrollLeftSelectedChanged?.Invoke(this, e);
        }
		#endregion
		...
		{			
            if (_tabContentBounds != tabContentBounds)
            {
