...
namespace System.Windows.Forms
{
         ...
         : RibbonRenderer
    {
        ...
        public override void OnRenderOrbDropDownBackground(RibbonOrbDropDownEventArgs e)
        {
            ...
            Color OrbDropDownBack = Theme.ColorTable.OrbBackgroundLight;
            ...
            GraphicsPath innerPath = RoundRectangle(InnerRect, e.Ribbon.OrbStyle == RibbonOrbStyle.Office_2013?0:6);
            GraphicsPath outerPath = RoundRectangle(OuterRect, e.Ribbon.OrbStyle == RibbonOrbStyle.Office_2013 ? 0 : 6);
