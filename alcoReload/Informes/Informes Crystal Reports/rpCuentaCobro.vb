...
Public Class rpCuentaCobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.rpCuentaCobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpCuentaCobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpCuentaCobro = New rpCuentaCobro()
        rpt.Site = Me.Site
        Return rpt
    End Function
