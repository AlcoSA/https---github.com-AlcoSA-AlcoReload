...
Public Class NotadeCobroXml
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.NotadeCobroXml.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotadeCobroXml
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotadeCobroXml = New NotadeCobroXml()
        rpt.Site = Me.Site
        Return rpt
    End Function
