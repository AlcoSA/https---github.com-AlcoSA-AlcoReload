...
Public Class cargas_viento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.cargas_viento.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ocultar_calculos() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcargas_viento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cargas_viento = New cargas_viento()
        rpt.Site = Me.Site
        Return rpt
    End Function
