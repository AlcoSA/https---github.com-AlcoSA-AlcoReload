...
Public Class calculo_NSR10
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.calculo_NSR10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcalculo_NSR10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As calculo_NSR10 = New calculo_NSR10()
        rpt.Site = Me.Site
        Return rpt
    End Function
