...
Public Class CotizacionClienteV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.CotizacionClienteV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCotizacionClienteV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CotizacionClienteV = New CotizacionClienteV()
        rpt.Site = Me.Site
        Return rpt
    End Function
