...
Public Class CotizacionInternaH
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.CotizacionInternaH.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCotizacionInternaH
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CotizacionInternaH = New CotizacionInternaH()
        rpt.Site = Me.Site
        Return rpt
    End Function
