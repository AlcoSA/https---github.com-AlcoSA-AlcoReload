...
Public Class rpPagoRetenidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.rpPagoRetenidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpPagoRetenidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpPagoRetenidos = New rpPagoRetenidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
