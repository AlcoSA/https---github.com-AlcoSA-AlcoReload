...
Public Class rpOrdenTrabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Informes.rpOrdenTrabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpOrdenTrabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpOrdenTrabajo = New rpOrdenTrabajo()
        rpt.Site = Me.Site
        Return rpt
    End Function
