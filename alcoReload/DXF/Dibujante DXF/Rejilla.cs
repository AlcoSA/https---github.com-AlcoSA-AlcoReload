...
{
    public class Rejilla : ComponenteVentana
    {        
        #region Constructor
        public Rejilla(PointF puntoinicial, string nombre) : base(puntoinicial, nombre)
        {
        }
        public Rejilla(PointF puntoinicial, PointF puntofinal, string nombre, string visibilidad) : base(puntoinicial, puntofinal, nombre, visibilidad)
        {
        }
        public Rejilla(PointF punto1, PointF punto2, PointF punto3, PointF punto4,bool circular, string nombre) : base(punto1, punto2, punto3, punto4, circular,nombre)
        {
        }
        public Rejilla(PointF punto1, PointF punto2, PointF punto3, PointF punto4, bool circular, string nombre, string visibilidad) : base(punto1, punto2, punto3, punto4, circular, nombre, visibilidad)
        {
        }
        #endregion
        ...
        public override void Dibujar(Graphics g, bool posrelativa = false)
        {
            ...
            if (FormaCircular)
            {
                ...
                g.FillEllipse(new HatchBrush(HatchStyle.Horizontal,
                                                    color, Color.Transparent), r);
            }
            else
            {
                ...
                g.FillPolygon(new HatchBrush(HatchStyle.Horizontal,
                                                    color, Color.Transparent), externos);
            }
            g.ResetTransform();           
        }
        #endregion
