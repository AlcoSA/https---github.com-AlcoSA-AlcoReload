...
Public Class FrmDepartamentosAlco

#Region "Variables"
    Private mdepartamentos As ClsDepartamentosAlco
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txtdepartamento.Text = r.Cells(Departamento.DataPropertyName).Value.ToString()
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mdepartamentos = New ClsDepartamentosAlco
            mdepartamentos.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            ...
            If Not objValidacion.TextBoxDigitado(txtdepartamento, ErrorProvider1) Then Return False
            Return True
        Catch ex As Exception
            Return False
        End Try
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validacion() Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mdepartamentos.Insertar(My.Settings.UsuarioActivo, txtdepartamento.Text, txtdescripcion.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mdepartamentos.Modificar(txtdepartamento.Text, txtdescripcion.Text, My.Settings.UsuarioActivo, Convert.ToInt32(cmbEstado.SelectedValue), curid)
                End If
        ...
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'IX_ti025_espesores_prefijo'") Then
                ...
                ErrorProvider1.SetError(txtdepartamento, "Ya existe un espesor con este prefijo. Verifique la información")
                Return
            End If
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
