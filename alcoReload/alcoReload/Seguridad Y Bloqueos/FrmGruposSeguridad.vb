...
Public Class FrmGruposSeguridad
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txtgrupo.Text = r.Cells(Grupo.DataPropertyName).Value.ToString()
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mgrupos = New ClsGruposSeguridad
            mgrupos.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            ...
            If Not objValidacion.TextBoxDigitado(txtgrupo, ErrorProvider1) Then Return False
            Return True
        Catch ex As Exception
            Return False
        End Try
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validacion() Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mgrupos.Insertar(My.Settings.UsuarioActivo, txtgrupo.Text, txtdescripcion.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mgrupos.Modificar(txtgrupo.Text, txtdescripcion.Text, My.Settings.UsuarioActivo, Convert.ToInt32(cmbEstado.SelectedValue), curid)
                End If
        ...
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'IX_ti025_espesores_prefijo'") Then
                ...
                ErrorProvider1.SetError(txtgrupo, "Ya existe un espesor con este prefijo. Verifique la información")
                Return
            End If
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
