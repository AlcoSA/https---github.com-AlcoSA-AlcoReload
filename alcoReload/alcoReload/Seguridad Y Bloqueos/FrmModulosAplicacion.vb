...
Public Class FrmModulosAplicacion

#Region "Variables"
    Private mmodulos As ClsModulosAplicacion
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mmodulos = New ClsModulosAplicacion
            mmodulos.TraerTodos(dwItems.TablaDatos)
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validacion() Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mmodulos.Insertar(My.Settings.UsuarioActivo, txtnombre.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mmodulos.Modificar(curid, My.Settings.UsuarioActivo, txtnombre.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                End If
        ...
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'IX_ti025_espesores_prefijo'") Then
                ...
                ErrorProvider1.SetError(txtnombre, "Ya existe un espesor con este prefijo. Verifique la información")
                Return
            End If
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
