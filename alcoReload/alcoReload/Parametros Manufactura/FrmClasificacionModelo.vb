...
Public Class FrmClasificacionModelo

#Region "Variables"
    Private mclasificacionmodelo As ClsClasificacionModelos
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txtclasificacion.Text = r.Cells(Clasificacion.DataPropertyName).Value
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mclasificacionmodelo = New ClsClasificacionModelos
            Dim objLista As List(Of ClasificacionModelo) = mclasificacionmodelo.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            ...
            If Not objValidacion.TextBoxDigitado(txtclasificacion, ErrorProvider1) Then Return False
            Return True
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
            Return False
        ...
        Try
            If Validacion() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mclasificacionmodelo.Ingresar(My.Settings.UsuarioActivo, txtclasificacion.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mclasificacionmodelo.Modificar(curid, My.Settings.UsuarioActivo, txtclasificacion.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                End If
            ...
            End If
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'ti005_clasifmodelos$fi005_clasificacion'") Then
                ErrorProvider1.Clear()
                ErrorProvider1.SetError(txtclasificacion, "Ya existe un registro con esta clasificación. Verifique la información")
                Return
            End If
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
