...
Public Class FrmTiposModelos

#Region "Variables"

    Private mtipomodelo As ClsTipoModelo
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txttipo.Text = r.Cells(Tipo.DataPropertyName).Value
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mtipomodelo = New ClsTipoModelo
            Dim objLista As List(Of TipoModelo) = mtipomodelo.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            ...
            If Not objValidacion.TextBoxDigitado(txttipo, ErrorProvider1) Then Return False
            Return True
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
            Return False
        ...
        Try
            If Validacion() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mtipomodelo.Ingresar(My.Settings.UsuarioActivo, txttipo.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mtipomodelo.Modificar(curid, My.Settings.UsuarioActivo, txttipo.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                End If
            ...
            End If
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'ti004_tipomodelo$fi004_tipo'") Then
                ErrorProvider1.Clear()
                ErrorProvider1.SetError(txttipo, "Ya existe este tipo de modelo. Verifique la información")
                Return
            End If
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
