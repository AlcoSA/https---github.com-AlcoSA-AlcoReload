...
Public Class FrmTiposMaterial

#Region "Variables"
    Private mtipomateral As ClsTiposMaterial
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mtipomateral = New ClsTiposMaterial
            Dim objLista As List(Of TipoMaterial) = mtipomateral.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
        ...
        Try
            ...
            If objValidacion.TextBoxDigitado(txtnombre, ErrorProvider1) Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mtipomateral.Ingresar(My.Settings.UsuarioActivo, txtnombre.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mtipomateral.Modificar(curid, My.Settings.UsuarioActivo, txtnombre.Text, cmbEstado.SelectedValue)
                End If
            ...
            End If
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'ti022_tipomaterial$fi022_nombre'") Then
                ErrorProvider1.Clear()
                ErrorProvider1.SetError(txtnombre, "Ya existe un tipo de material con este nombre. Verifique la información")
                Return
            End If
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
