...
Public Class FrmFamiliasMateriales

#Region "Variables"

    Private mfamiliasmaterial As ClsFamiliaMaterial
    Private tform As ClsEnums.TiOperacion = ClsEnums.TiOperacion.INSERTAR
    Private curid As Integer = 0
    Private objValidacion As ClsValidaciones
    Private fuenteIncial As DataTable = Nothing
#End Region
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txtfamilia.Text = r.Cells(Familia_Materia.DataPropertyName).Value
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mfamiliasmaterial = New ClsFamiliaMaterial
            Dim objLista As List(Of FamiliaMaterial) = mfamiliasmaterial.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
        ...
        Try
            If Validacion() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mfamiliasmaterial.Ingresar(My.Settings.UsuarioActivo, txtfamilia.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mfamiliasmaterial.Modificar(curid, My.Settings.UsuarioActivo, txtfamilia.Text, txtPrefijo.Text, cmbEstado.SelectedValue)
                End If
