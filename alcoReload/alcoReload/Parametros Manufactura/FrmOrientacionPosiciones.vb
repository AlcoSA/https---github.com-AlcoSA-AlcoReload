...
Public Class FrmOrientacionPosiciones
#Region "Variables"
    Private mOrientaPos As New ClsOrientacionPosicionMaterial
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            cmbEstado.SelectedValue = Convert.ToInt32(r.Cells(IdEstado.DataPropertyName).Value)
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mOrientaPos = New ClsOrientacionPosicionMaterial
            Dim objLista As List(Of OrientacionPosicion) = mOrientaPos.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
        ...
        Try
            If Validacion() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mOrientaPos.Ingresar(My.Settings.UsuarioActivo, txtnombre.Text, txtDescripcion.Text, txtprefijo.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mOrientaPos.Modificar(curid, My.Settings.UsuarioActivo, txtnombre.Text, txtDescripcion.Text, txtprefijo.Text, cmbEstado.SelectedValue)
                End If
            ...
            End If
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'ti007_orientacionyposicionmaterial$fi007_prefijo'") Then
                ErrorProvider1.Clear()
                ErrorProvider1.SetError(txtprefijo, "Ya existe un registro con este prefijo. Verifique la información")
                Return
            End If
            If ex.Message.Contains("UNIQUE KEY 'ti007_orientacionyposicionmaterial$fi007_nombre'") Then
                ErrorProvider1.Clear()
