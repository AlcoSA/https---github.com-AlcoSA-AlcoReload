...
Public Class FrmEspesores

#Region "Variables"
    Private maEspesores As ClsEspesores
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            maEspesores = New ClsEspesores
            Dim objLista As List(Of Espesor) = maEspesores.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validacion() Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    maEspesores.Ingresar(My.Settings.UsuarioActivo, txtPrefijo.Text, txtDescripcion.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    maEspesores.Modificar(curid, My.Settings.UsuarioActivo, txtPrefijo.Text, txtDescripcion.Text, cmbEstado.SelectedValue)
                End If
        ...
        Catch ex As Exception
            If ex.Message.Contains("UNIQUE KEY 'IX_ti025_espesores_prefijo'") Then
                ...
                ErrorProvider1.SetError(txtPrefijo, "Ya existe un espesor con este prefijo. Verifique la información")
                Return
            End If
