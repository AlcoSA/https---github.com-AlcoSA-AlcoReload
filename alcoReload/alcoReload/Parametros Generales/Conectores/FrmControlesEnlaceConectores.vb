...
Public Class FrmControlesEnlaceConectores

#Region "Variables"
    Private mcontr As ClsControlesEnlace
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txtcontrol.Text = r.Cells(control.Index).Value.ToString()
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mcontr = New ClsControlesEnlace
            mcontr.TraerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            Dim objValidacion As New Validaciones.ClsValidaciones
            If Not objValidacion.TextBoxDigitado(txtcontrol, ErrorProvider1) Then Return False
            Return True
        Catch ex As Exception
            Return False
        End Try
        ...
        Try
            If Validacion() Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mcontr.Insertar(My.Settings.UsuarioActivo, txtcontrol.Text, cmbEstado.SelectedValue)
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mcontr.Modificar(curid, My.Settings.UsuarioActivo, txtcontrol.Text, cmbEstado.SelectedValue)
                End If
    ...
    Private Sub dw_CellMouseClick(sender As Object, e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dwItems.CellMouseClick
        Try
            If e.RowIndex >= 0 And e.Button = Windows.Forms.MouseButtons.Right Then
                ...
                menu.Show(Windows.Forms.Control.MousePosition)
            End If
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
