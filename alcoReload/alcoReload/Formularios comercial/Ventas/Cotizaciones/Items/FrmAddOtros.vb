...
Public Class FrmAddOtros
#Region "Variables"
    Private tform As ClsEnums.TiOperacion = ClsEnums.TiOperacion.INSERTAR
    Private _curid As Integer = 0
    Private _articulo As articuloTemporal
...
#Region "Propiedades"
    ...
    Public Property CurId() As Integer
        ...
        End Set
    End Property
    Public Property Articulo() As articuloTemporal
        Get
            Return _articulo
        End Get
...
#Region "Procedimientos"
    Private Sub cargarItems()
        Try
            ...
            Dim list As List(Of articuloTemporal) = mArtTemp.TraerConExistentes(_idCotiza, ClsEnums.FamiliasMateriales.OTROS, itItem.TablaFuente)
    ...
    Private Function validacion()
        Try
            If itItem.Text = String.Empty Then
                ErrorProvider.SetError(itItem, "Debe indicar el artículo que va a agregar")
                Return False
            End If
            ErrorProvider.Clear()
            If nudCantidad.Value = 0 Then
                ErrorProvider.SetError(nudCantidad, "Debe indicar la cantidad de artículos")
                Return False
            End If
            ErrorProvider.Clear()
            ...
            Dim mArtTemp As New ClsArticuloTemporal
            Dim art As articuloTemporal = mArtTemp.TraerConExistentesPorReferencia(_idCotiza, ClsEnums.FamiliasMateriales.OTROS, itItem.Text)
            If art.Temporal = False Then
                If mCostoOtros.TraerxIdArticulo(art.Id, _versionCostoOtros).costo = 0 Then
    ...
    Private Sub cargarTrabajos()
        Try
            ...
            Dim listTrabajos As List(Of trabajoItems) = mTrabajo.TraerxFamiliaMaterial(ClsEnums.FamiliasMateriales.OTROS)
    ...
    End Sub
#End Region
    Private Sub FrmAddOtros_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            cargarItems()
            cargarAcabados()
            cargarTrabajos()
            ...
            If tform = ClsEnums.TiOperacion.MODIFICAR Then
                itItem.Text = _articulo.Referencia
                itItem.Seleted_rowid = _articulo.Id
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        Try
            ...
            If validacion() Then
                Dim mArtTemp As New ClsArticuloTemporal
                _articulo = mArtTemp.TraerConExistentesPorReferencia(_idCotiza, ClsEnums.FamiliasMateriales.OTROS, itItem.Text)
