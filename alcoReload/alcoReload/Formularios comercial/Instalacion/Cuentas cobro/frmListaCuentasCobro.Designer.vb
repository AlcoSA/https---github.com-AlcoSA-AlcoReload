...
Partial Class frmListaCuentasCobro
    ...
    Private Sub InitializeComponent()
        ...
        Me.Panel.Name = "Panel"
        Me.Panel.Size = New System.Drawing.Size(679, 464)
        Me.Panel.TabIndex = 1
        '
        'dwItems
        '
        ...
        Me.dwItems.Columns.AddRange(New System.Windows.Forms.DataGridViewColumn() {Me.id, Me.fechaCreacion, Me.usuarioCreacion, Me.idContrato, Me.idDocumento, Me.documento, Me.consecutivo, Me.idProveedor, Me.proveedor, Me.idEncargado, Me.encargado, Me.codigoObra, Me.obra, Me.vendedor, Me.usuarioModi, Me.fechaModi, Me.idEstadoImpresion, Me.estadoImpresion, Me.idEstado, Me.estado, Me.observaciones})
        ...
        Me.dwItems.Size = New System.Drawing.Size(675, 359)
        ...
        Me.Name = "frmListaCuentasCobro"
        Me.ShowIcon = False
        Me.Text = "Lista cuentas cobro"
