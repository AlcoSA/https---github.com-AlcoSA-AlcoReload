...
Public Class frmObjetos
#Region "Variables"
    Private _objContratos As clsObjetosContratos
        ...
        Try
            If _tipoOperacom = ClsEnums.TiOperacion.INSERTAR Then
                If _validacion.TextBoxDigitado(txtDescripcion, ErrorProvider1) Then
                    _objContratos = New clsObjetosContratos
                    _objContratos.insert(My.Settings.UsuarioActivo, txtDescripcion.Text, cmbEstado.SelectedValue)
                End If
            ...
            Else
                If _validacion.TextBoxDigitado(txtDescripcion, ErrorProvider1) Then
                    _objContratos = New clsObjetosContratos
                    _objContratos.update(_idToEdit, txtDescripcion.Text, My.Settings.UsuarioActivo, cmbEstado.SelectedValue)
                End If
...
#Region "Procedimientos Controles"
    ...
    Private Sub frmObjetos_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            Dim listaObjetosContratos As List(Of objetoContrato) = _objContratos.traerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
