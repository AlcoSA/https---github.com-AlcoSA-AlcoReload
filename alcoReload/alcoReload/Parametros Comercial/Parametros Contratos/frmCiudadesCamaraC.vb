...
Public Class frmCiudadesCamaraC
#Region "Variables"
    Private _objCamarasComercio As clsCiudadesCamaraComercio
...
#Region "Procedimientos Usuarios"
        ...
        Try
            If _tipoOperacom = ClsEnums.TiOperacion.INSERTAR Then
                If _validacion.TextBoxDigitado(txtDescripcion, ErrorProvider1) Then
                    _objCamarasComercio = New clsCiudadesCamaraComercio
                    _objCamarasComercio.insert(My.Settings.UsuarioActivo, txtDescripcion.Text, cmbEstado.SelectedValue)
                End If
            ...
            Else
                If _validacion.TextBoxDigitado(txtDescripcion, ErrorProvider1) Then
                    _objCamarasComercio = New clsCiudadesCamaraComercio
                    _objCamarasComercio.update(_idToEdit, txtDescripcion.Text, My.Settings.UsuarioActivo, cmbEstado.SelectedValue)
                End If
    ...
    Private Sub Modificar()
        Try
            ...
            txtDescripcion.Text = r.Cells(ciudad.DataPropertyName).Value.ToString().Trim
...
#Region "Procedimientos Controles"
    ...
    Private Sub frmObjetos_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            Dim listaObjetosContratos As List(Of objetoContrato) = _objCamarasComercio.traerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
