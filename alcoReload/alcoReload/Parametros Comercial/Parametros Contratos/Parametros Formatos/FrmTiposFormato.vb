...
Public Class FrmTiposFormato

#Region "Variables"
    Private mtipoformato As ClsTiposFormato
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            txttipoformato.Text = r.Cells(tipo_Formato.Index).Value
...
#End Region
    ...
    Private Sub Frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            mtipoformato = New ClsTiposFormato
            dwItems.TablaDatos = mtipoformato.TraerTodosTabla()
            cargarEstados()
        Catch ex As Exception
            ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validacion() As Boolean
        Try
            ...
            If Not objValidacion.TextBoxDigitado(txttipoformato, ErrorProvider1) Then Return False
        ...
        Try
            If Validacion() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mtipoformato.Insertar(My.Settings.UsuarioActivo, txttipoformato.Text,
                                          txtdescripcion.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mtipoformato.Modificar(curid, My.Settings.UsuarioActivo, txttipoformato.Text,
                                           txtdescripcion.Text, Convert.ToInt32(cmbEstado.SelectedValue))
                End If
    ...
    Private Sub btnLimpiar_Click(sender As System.Object, e As System.EventArgs)
        Try
            curid = 0
            txttipoformato.Text = String.Empty
