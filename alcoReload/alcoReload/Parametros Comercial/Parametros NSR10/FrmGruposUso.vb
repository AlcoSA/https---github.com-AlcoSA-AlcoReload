...
Public Class FrmGruposUso
#Region "Variables"
    Private mGruposUso As ClsGrupoUso
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            curid = Convert.ToInt32(r.Cells(Id_Grupo_Uso.DataPropertyName).Value)
            txtDescripcion.Text = r.Cells(Grupo_Uso.DataPropertyName).Value
...
#End Region
    ...
    Private Sub FrmGruposUso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            mGruposUso = New ClsGrupoUso
            Dim objLista As List(Of grupoUso) = mGruposUso.traerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validar() As Boolean
        Try
            ...
            If tform = ClsEnums.TiOperacion.INSERTAR Then
                If mGruposUso.TraerxDescripcion(txtDescripcion.Text) = True Then
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validar() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mGruposUso.Ingresar(My.Settings.UsuarioActivo, txtDescripcion.Text,
                                        cmbEstado.SelectedValue, Convert.ToInt32(cbValorDefecto.Checked))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mGruposUso.Modificar(txtDescripcion.Text, My.Settings.UsuarioActivo,
                ...
                FrmGruposUso_Load(Nothing, Nothing)
            Else
                Return
            End If
        Catch ex As Exception
