...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            curid = Convert.ToInt32(r.Cells(Id_Tipo_Cubierta.DataPropertyName).Value)
            txtDescripcion.Text = r.Cells(Tipo_Cubierta.DataPropertyName).Value.ToString()
...
#End Region
    ...
    Private Sub Frm_Deactivate(sender As Object, e As System.EventArgs) Handles Me.Deactivate
        ...
        End Try
    End Sub
    Private Sub TiposCubierta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            mTipoCubierta = New ClsTipoCubierta
            Dim objLista As List(Of tipoCubuertas) = mTipoCubierta.traerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validaciones() As Boolean
        Try
            ...
            If tform = ClsEnums.TiOperacion.INSERTAR Then
                If mTipoCubierta.TraerxDescripcion(txtDescripcion.Text) = True Then
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            ...
            If objValidacion.TextBoxDigitado(txtDescripcion, ErrorProvider1) Then
                ...
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mTipoCubierta.Ingresar(My.Settings.UsuarioActivo, txtDescripcion.Text,
                                           cmbEstado.SelectedValue, Convert.ToInt32(cbValorDefecto.Checked))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mTipoCubierta.Modificar(txtDescripcion.Text, My.Settings.UsuarioActivo,
                ...
                TiposCubierta_Load(Nothing, Nothing)
            Else
                Return
            End If
        Catch ex As Exception
