...
Public Class FrmCategoriasExp

#Region "Variables"
    Private mCategExp As ClsCategExposicion
...
#Region "Procedimientos"
    ...
    Private Sub Modificar()
        Try
            ...
            curid = Convert.ToInt32(r.Cells(Id_Categoria_Exposicion.DataPropertyName).Value)
            txtDescripcion.Text = r.Cells(Categoria_Exposicion.DataPropertyName).Value.ToString()
...
#End Region
    ...
    Private Sub FrmCategoriasExposicion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            mCategExp = New ClsCategExposicion
            Dim objLista As List(Of categExposicion) = mCategExp.traerTodos(dwItems.TablaDatos)
            cargarEstados()
        Catch ex As Exception
        ManejoExcepciones.MensajeExcepcion.Show(ex, ManejoExcepciones.TipoExcepcion.Critica)
        End Try
    ...
    Private Function Validar() As Boolean
        Try
            ...
            If tform = ClsEnums.TiOperacion.INSERTAR Then
                If mCategExp.TraerxDescripcion(txtDescripcion.Text) = True Then
    ...
    Private Sub GuardadoTotal_Click(sender As System.Object, e As System.EventArgs)
        Try
            If Validar() Then
                If tform = ClsEnums.TiOperacion.INSERTAR Then
                    mCategExp.Ingresar(My.Settings.UsuarioActivo, txtDescripcion.Text,
                                           cmbEstado.SelectedValue, Convert.ToInt32(cbValorDefecto.Checked))
                ElseIf tform = ClsEnums.TiOperacion.MODIFICAR Then
                    mCategExp.Modificar(txtDescripcion.Text, My.Settings.UsuarioActivo,
                ...
                FrmCategoriasExposicion_Load(Nothing, Nothing)
            Else
                Return
            End If
        Catch ex As Exception
